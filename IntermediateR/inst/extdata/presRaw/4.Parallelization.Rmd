...
* epxlain concept of threads and cores etc and running multiple processes on a tpyical laptop. what are limits?

* dig into parallelization - can do general but also applied
* could also do genreal sxcripting and building workflow i..e warnings, trycatch, debug
